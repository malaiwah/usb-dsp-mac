#!/usr/bin/env python3
"""
Full disassembly of the function that sets 0x2000016f (around 0x0800ab6a).
Also look at fn_aadc to understand the full USB HID RX packet assembly.
"""
import struct
...
# Disassemble from just after fn_aa80 ends to see what's between aa80 and ab8c
# fn_aa80 ends at 0x0800aada (pop {r4,r5,r6,r7,pc})
# Next function starts at 0x0800aadc
disasm_fn(0x0800aadc, 300, 'fn_aadc (HID RX assembly)', stop_early=False)

# Also look at the USART1 packet handler that writes to the SRAM at 0x08005b60 area
disasm_fn(0x08005a80, 400, 'fn_5a80 (USART assembler?)', stop_early=False)
